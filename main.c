    ...
    int bloco = obterBloco(enderecoRam),
        ...
        case 1:
            ...
            case 1:
                ...
                if(indiceCopias[1] != -1)
                {   
                    // linha copia recebe a linha aonde se encontra a copia
            ...
            case 2:
                // SE A CÓPIA ESTIVER NA CACHE 1  (POIS indiceCopias[idCache-1] GUARDA A LINHA AONDE SE ENCONTRA A CÓPIA)
                if(indiceCopias[0] != -1)
                {   
                    // linha copia recebe a linha aonde se encontra a copia
