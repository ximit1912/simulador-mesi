...
/*
VERIFICA SE A CACHE ESTÁ PREENCHIDA OU NAO
    1- SE SIM, ATRIBUI DO VIZINHO, COM FIFO ou SUBSTITUINDO UMA LINHA INVÁLIDA SE HOUVER. E ATUALIZA PARA ESTADO S - SHARED AMBAS AS CACHES
    ...
    case 1:
        ...
        case 1:
            ...
            if (indiceCopias[1] != -1)
            {
                ...
                {
                    RAM.dado[bloco*2 + dado] = CACHE[1].linha[linhaCopia].bloco.dado[dado];
                    printf("\n\n!!Dado atualizado na RAM na posicao %d!!\n\n", bloco*2 + dado);
                }
